...
class SwinDSCNet(nn.Module):
    def __init__(
        ...
        init_DSConvFusion = lambda in_ch, out_ch : MultiView_DSConv(in_ch, out_ch, kernel_size, extend_scope)
...
if __name__=="__main__":
    model = SwinDSCNet(model_type="DSCNet", layer_depth=3) # 3, 4,
    summary(model, (1, 3, 400, 400), device=device)
    # print(model)
    # depth 4: DSCNet:  97M, SwinDSCNet: 117M, 16745.36 MB
    # depth 5: DSCNet: 15277.32 MB, SwinDSCNet: 21363.35 MB 17062.55